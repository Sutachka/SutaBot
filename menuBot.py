...
m_games = Menu("Игрульки", buttons=["Игра КНБ", "Игра в 21", "Угадай число", "Выход"], parent=m_main)
...
m_fun = Menu("Развлечения", buttons=["Пёсики", "Лисята", "Приколдесы", "Курс биткоина", "Фактик", "Прислать фильм", "Выход"], parent=m_main, module="fun")
